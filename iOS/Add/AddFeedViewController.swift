...
class AddFeedViewController: UITableViewController {
	...
	override func viewDidLoad() {
		...
		switch addFeedType {
		case .reddit:
			navigationItem.title = NSLocalizedString("ADD_REDDIT_FEED", comment: "Add Reddit Feed")
			navigationItem.leftBarButtonItem = nil
		case .twitter:
			navigationItem.title = NSLocalizedString("ADD_TWITTER_FEED", comment: "Add Twitter Feed")
			navigationItem.leftBarButtonItem = nil
		default:
			break
		}
