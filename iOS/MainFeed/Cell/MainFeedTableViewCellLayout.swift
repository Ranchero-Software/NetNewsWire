...
@MainActor struct MainFeedTableViewCellLayout {
	...
	init(cellWidth: CGFloat, insets: UIEdgeInsets, label: UILabel, unreadCountView: MainFeedUnreadCountView, showingEditingControl: Bool, indent: Bool, shouldShowDisclosure: Bool, itemIsInFolder: Bool) {
		...
		if !shouldShowDisclosure {
			...
			if itemIsInFolder {
				rFavicon = CGRect(x: x + MainFeedTableViewCellLayout.disclosureButtonSize.width - (MainFeedTableViewCellLayout.imageSize.width / 2), y: y, width: MainFeedTableViewCellLayout.imageSize.width, height: MainFeedTableViewCellLayout.imageSize.height)
			} else {
		...
		// Title
		var rLabelx = MainFeedTableViewCellLayout.disclosureButtonSize.width + insets.left
		if itemIsInFolder {
			rLabelx += MainFeedTableViewCellLayout.disclosureButtonSize.width - (rFavicon.width / 2)
		}
