...
class FindFeedController: FindFeedWindowControllerDelegate {
	...
	func findFeedWindowController(_: FindFeedWindowController, userEnteredURL url: URL, userEnteredTitle title: String?, container: Container) {
...
private extension FindFeedController {
	...
	func closeAddFeedSheet(_ returnCode: NSApplication.ModalResponse) {
		...
		if let sheetWindow = findFeedWindowController?.window {
