...
struct RSParsedFeedTransformer {
	...
	static func parsedFeed(_ rsParsedFeed: RSParsedFeed) -> ParsedFeed {
		...
		return ParsedFeed(type: .rss, title: rsParsedFeed.title, homePageURL: rsParsedFeed.homepageURLString, feedURL: rsParsedFeed.urlString, language: rsParsedFeed.language, feedDescription: nil, nextURL: nil, iconURL: rsParsedFeed.iconURL, faviconURL: nil, authors: nil, expired: false, hubs: nil, items: items)
	}
}
