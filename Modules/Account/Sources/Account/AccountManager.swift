...
@MainActor public final class AccountManager: UnreadCountProvider {
	...
	public func duplicateServiceAccount(type: AccountType, endpointURL: URL?) -> Bool {
		Self.duplicateServiceAccount(type: type, endpointURL: endpointURL, among: accounts)
	}

	static func duplicateServiceAccount(type: AccountType, endpointURL: URL?, among accounts: [Account]) -> Bool {
